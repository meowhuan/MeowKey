...
if ($Preset) {
    ...
    Set-FromPreset -ParameterName "UserPresenceSource" -PresetValue ([string]$presetConfig.userPresenceSource)
    Set-FromPreset -ParameterName "UserPresenceGpioPin" -PresetValue ([int]$presetConfig.userPresenceGpioPin)
    Set-FromPreset -ParameterName "UserPresenceGpioActiveState" -PresetValue ([string]$presetConfig.userPresenceGpioActiveState)
    Set-FromPreset -ParameterName "UserPresenceTapCount" -PresetValue ([int]$presetConfig.userPresenceTapCount)
    Set-FromPreset -ParameterName "UserPresenceGestureWindowMs" -PresetValue ([int]$presetConfig.userPresenceGestureWindowMs)
    Set-FromPreset -ParameterName "UserPresenceTimeoutMs" -PresetValue ([int]$presetConfig.userPresenceTimeoutMs)
